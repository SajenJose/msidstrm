...
namespace Msidstrm
{
    ...
    class getFilePathClassLength
    {
        ...
        public static void getFilePathLen(string[] filePath)
        {
            ...
            try
            {
                ...
                //string filesig = "msidstrm.codeplex.com"; //this is a line that needs to be reviewed.
    ...
    /// <summary>
    /// Class:                  Get CPU Details
    /// Description:            This class contains the methods used to obtain the CPU details of the computer. 
    /// </summary>
    class getcpudetails
    {
        public static void getCPUDetails()
        {
            Program.copyrightBanner();
            Console.ForegroundColor = ConsoleColor.White;
            foreach (var item in new System.Management.ManagementObjectSearcher("Select * from Win32_ComputerSystem").Get())
            {
                ...
                Console.WriteLine("----------------");
                Console.WriteLine("Number of Phyical Processors: {0} ", item["NumberOfProcessors"]);
            ...
            foreach (var item in new System.Management.ManagementObjectSearcher("Select * from Win32_Processor").Get())
            {
                ...
                Console.WriteLine("Architecture: {0}", GetArchDetail(int.Parse(item["Architecture"].ToString())));
                Console.WriteLine("Current ClockSpeed: {0} MHz", item["CurrentClockSpeed"].ToString());
                Console.WriteLine("L2 Cache Size: {0} Kilobytes", item["L2CacheSize"].ToString());
                Console.WriteLine("CPU Manufacturer: {0}", item["Manufacturer"].ToString());
            }

            Console.WriteLine("Number Of Cores: {0}", numberOfCores);
        }

        public static string GetArchDetail(int architecturenumber)
        {
            switch (architecturenumber)
            {
                case 0: return "x86 - 32 bit Computer";
                case 1: return "MIPS";
                case 2: return "Alpha";
                case 3: return "PowerPC";
                case 5: return "ARM";
                case 6: return "Itanium based Computer";
                case 9: return "x64 - 64 bit Computer";
